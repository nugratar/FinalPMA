...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    private OnItemClickListener<ListMovie> clickListener;

    public MovieAdapter(List<ListMovie> results) {
    }

    public void appendList(List<Movie> movieListToAppend) {
        listMovies.addAll(movieListToAppend);
    }

    public void setClickListener(OnItemClickListener<ListMovie> clickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            clickListener.onClick(listMovies.get(getBindingAdapterPosition()));
        }
    }
}
